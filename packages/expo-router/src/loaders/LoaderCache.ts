...
// to a fresh fetch, then bump the cache version so subscribed hooks re-render. The registration
// guard is global rather than function-identity-based because HMR may re-evaluate this module and
// recreate the listener function.
